#!/usr/bin/env node
// Run from fpk-backend folder: node fix-email-mailgun-api.js
...
console.log('\\nUpdating email service to use Mailgun API...\\n');
...
console.log('');
console.log('  MAILGUN_API_KEY=your-api-key-here');
console.log('  MAILGUN_DOMAIN=your-sending-domain.com');
console.log('  MAILGUN_FROM_EMAIL=verify@funpizzakitchen.com');
console.log('');
